function [sys,x0,str,tss]=RBsuperheater4_FGDyn(t,x,u,flag,Param6,X_ss)
...
% Outputs Auxilary:
Q_4=FG_flow*Cp_FG *(T_FGin4-TFG_out4);
...
sys(1) =(FG_flow*(Cp_FG* T_FGin4 - Cp_FG*TFG_out4) - U*(2*pi*r_tube*L_tube*n_tube)*(TFG_out4-Ts_out4))/(rho_FG*Cp_FG*(A_FG*L_tube*n_tube)+M_tube *Cp_M);
