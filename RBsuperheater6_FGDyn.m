function [sys,x0,str,tss]=RBsuperheater6_FGDyn(t,x,u,flag,Param6,X_ss)
...
% Outputs Auxilary:
Q_6=FG_flow*Cp_FG *(T_FGin6-TFG_out6);
...
sys(1) =(FG_flow*(Cp_FG* T_FGin6 - Cp_FG*TFG_out6) - U*(2*pi*r_tube*L_tube*n_tube)*(TFG_out6-Ts_out6))/(rho_FG*Cp_FG*(A_FG*L_tube*n_tube)+M_tube *Cp_M);
