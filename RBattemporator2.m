function [sys,x0,str,tss]=RBattemporator2(t,x,u,flag,Param4,X_ss)
...
%properties 
rho_SHRB_in= XSteam ('rho_pT',RB_p,Ts_in_attemp2); %density steam (in) from previous compartment
rho_SHRB_out= XSteam ('rho_pT',RB_p, Ts_out_attemp2); %density steam (out) 
Cp_s_in = XSteam ('Cp_pT',RB_p,Ts_in_attemp2) ; %Cp steam T_in
Cp_s_out = XSteam ('Cp_pT',RB_p,Ts_out_attemp2) ; %Cp steam T_out
