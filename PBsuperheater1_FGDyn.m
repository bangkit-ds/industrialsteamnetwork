function [sys,x0,str,tss]=PBsuperheater1_FGDyn(t,x,u,flag,Param5,X_ss)
...
% Outputs Auxilary:
Q_1=FG_flow*Cp_FG *(T_FGin1-TFG_out1);
...
sys(1) =(FG_flow*(Cp_FG* T_FGin1 - Cp_FG*TFG_out1) - U*(2*pi*r_tube*L_tube*n_tube)*(TFG_out1-Ts_out1))/(rho_FG*Cp_FG*(A_FG*L_tube*n_tube)+M_tube *Cp_M);
