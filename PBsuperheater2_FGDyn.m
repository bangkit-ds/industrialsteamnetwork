function [sys,x0,str,tss]=PBsuperheater2_FGDyn(t,x,u,flag,Param5,X_ss)
...
% Outputs Auxilary:
Q_2=FG_flow*Cp_FG *(T_FGin2-TFG_out2);
...
sys(1) =(FG_flow*(Cp_FG* T_FGin2 - Cp_FG*TFG_out2) - U*(2*pi*r_tube*L_tube*n_tube)*(TFG_out2-Ts_out2))/(rho_FG*Cp_FG*(A_FG*L_tube*n_tube)+M_tube *Cp_M);
